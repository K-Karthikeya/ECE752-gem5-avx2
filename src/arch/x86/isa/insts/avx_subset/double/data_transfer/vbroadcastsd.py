microcode = """
def macroop VBROADCASTSD_128_XMM_XMM {
    vbcastf dest=xmm0, src=xmmrm, size=8, VL=16
};
...
def macroop VBROADCASTSD_256_XMM_XMM {
    vbcastf dest=xmm0, src=xmmrm, size=8, VL=32
};
