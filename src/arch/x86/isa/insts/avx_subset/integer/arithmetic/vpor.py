...
def macroop VPOR_128_XMM_XMM {
    vori dest=xmm0, src1=xmm0v, src2=xmmrm, size=4, VL=16
};
def macroop VPOR_128_XMM_M {
    ldfp128 ufp0, seg, sib, "DISPLACEMENT", dataSize=8
    vori dest=xmm0, src1=xmm0v, src2=ufp0, size=4, VL=16
};
def macroop VPOR_128_XMM_P {
    rdip t7
...
def macroop VPOR_256_XMM_XMM {
    vori dest=xmm0, src1=xmm0v, src2=xmmrm, size=4, VL=32
};
def macroop VPOR_256_XMM_M {
    ldfp256 ufp0, seg, sib, "DISPLACEMENT", dataSize=8
    vori dest=xmm0, src1=xmm0v, src2=ufp0, size=4, VL=32
};
def macroop VPOR_256_XMM_P {
    rdip t7
