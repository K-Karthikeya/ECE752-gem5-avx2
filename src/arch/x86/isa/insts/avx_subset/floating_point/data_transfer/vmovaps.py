microcode = '''
<<<<<<< HEAD
def macroop VMOVAPS_128_XMM_M {
    ldfp128 xmm0, seg, sib, "DISPLACEMENT", dataSize=8
    vclear dest=xmm2, destVL=16
};
def macroop VMOVAPS_128_XMM_P {
=======
...
>>>>>>> b19882703298030c4b974bc38dcb2d839a2e0791
    rdip t7
...
def macroop VMOVAPS_256_YMM_M {
    ldfp256 xmm0, seg, sib, "DISPLACEMENT", dataSize=8
};
def macroop VMOVAPS_256_YMM_P {
    rdip t7
